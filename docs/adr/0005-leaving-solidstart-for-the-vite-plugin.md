...
- **Performance tracing is decided** (the separate decision ADR 0001 decision 5 deferred). That is when the router-tracing cost above stops being hypothetical and needs a real answer for `@solidjs/router` 2.
