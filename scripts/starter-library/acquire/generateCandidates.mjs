...
function mapFsldGenres(genres) {
  ...
  for (const g of genres) {
    for (const key of FSLD_GENRE_MAP[String(g).toLowerCase()] ?? []) mapped.add(key);
  }
  return [...mapped];
}
...
const FREEPATS_BANKS = [
  ...
  ["synth-bass", "Synthesizer/synth-bass.html", "bass", "sustained", ["house", "techno"]],
  ["synth-lead", "Synthesizer/synth-lead.html", "tonal", "pluck", ["trance", "techno"]],
  ["synth-pad", "Synthesizer/synth-pad.html", "texture", "drone", ["ambient", "trance"]],
  [
    "synth-strings",
  ...
  ["glass", "ChromaticPercussion/glass.html", "tonal", "bell", ["ambient", "lofi"]],
  ["hang", "ChromaticPercussion/hang.html", "tonal", "mallet", ["ambient", "lofi"]],
  [
    "tubular-bells",
...
function generate() {
  ...
  for (const c of candidates) {
    byConfidence[c.licenseConfidence] = (byConfidence[c.licenseConfidence] ?? 0) + 1;
