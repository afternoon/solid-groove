...
describe("CORS configuration", () => {
	...
	it("binds the checked-in policy to a concrete project", () => {
		const [rule] = corsConfigFor("solid-groove");
		expect(rule.origin).toContain("https://solid-groove.web.app");
		expect(rule.origin).toContain("https://solid-groove.firebaseapp.com");
		expect(rule.origin.join(" ")).not.toContain("{{PROJECT_ID}}");
