...
export function createTrack(
  ...
  return {
    ...
    mixer: {
      ...
      pan: clampParameterValue(TRACK_PAN, options.pan ?? TRACK_PAN.defaultValue),
...
export function createSamplerInstrument(assetId: AssetId | null = null): Instrument {
...
export function createDrumMachineInstrument(pads: readonly DrumPad[] = []): Instrument {
