 ...
 * e.g. `bunx playwright test --config=tests/e2e/emulator/playwright.config.ts --list`.
 */
...
export default defineConfig({
  ...
  // `tests/e2e/emulator/warmDevServer.setup.ts` for what that reload broke and why
